...
public class HisApplicant {
    ...
    private String applicant_trueorfalse;   //是否贷款成功
    private String applicant_yuanyin;      //失败
    private String user_character;         //申请人帐号

    public HisApplicant() {
    }

    public HisApplicant(String applicant_serial_number, String applicant_name, String applicant_telphone, String applicant_id_type, String applicant_id_number, String applicant_land, String applicant_work_age, String applicant_address, String applicant_use, int applicant_aggregate_amount, String applicant_email, String applicant_card_number, String applicant_state, String applicant_time, int facility_id, int partner_id, String applicant_trueorfalse, String applicant_yuanyin) {
        ...
        this.applicant_trueorfalse = applicant_trueorfalse;
        this.applicant_yuanyin = applicant_yuanyin;
    }

    public HisApplicant(String applicant_serial_number, String applicant_name, String applicant_telphone, String applicant_id_type, String applicant_id_number, String applicant_land, String applicant_work_age, String applicant_address, String applicant_use, int applicant_aggregate_amount, String applicant_email, String applicant_card_number, String applicant_state, String applicant_time, int facility_id, int partner_id, String applicant_trueorfalse) {
        this.applicant_serial_number = applicant_serial_number;
        this.applicant_name = applicant_name;
        this.applicant_telphone = applicant_telphone;
        this.applicant_id_type = applicant_id_type;
    ...
    public HisApplicant(int applicant_id, String applicant_serial_number, String applicant_name, String applicant_telphone, String applicant_id_type, String applicant_id_number, String applicant_land, String applicant_work_age, String applicant_address, String applicant_use, int applicant_aggregate_amount, String applicant_email, String applicant_card_number, String applicant_state, String applicant_time, int facility_id, int partner_id, String applicant_trueorfalse, String applicant_yuanyin) {
    ...
    public HisApplicant(String applicant_serial_number, String applicant_name, String applicant_telphone, String applicant_id_type, String applicant_id_number, String applicant_land, String applicant_work_age, String applicant_address, String applicant_use, int applicant_aggregate_amount, String applicant_email, String applicant_card_number, String applicant_state, String applicant_time, int facility_id, int partner_id, String applicant_trueorfalse, String applicant_yuanyin, String user_character) {
        this.applicant_serial_number = applicant_serial_number;
        this.applicant_name = applicant_name;
        this.applicant_telphone = applicant_telphone;
        this.applicant_id_type = applicant_id_type;
    ...
    public String getApplicant_trueorfalse() {
        return applicant_trueorfalse;
    }

    public void setApplicant_trueorfalse(String applicant_trueorfalse) {
        this.applicant_trueorfalse = applicant_trueorfalse;
    }

    public String getApplicant_yuanyin() {
        return applicant_yuanyin;
    }

    public void setApplicant_yuanyin(String applicant_yuanyin) {
        this.applicant_yuanyin = applicant_yuanyin;
    }
}
