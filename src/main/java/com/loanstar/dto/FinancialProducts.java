...
public class FinancialProducts {
    ...
    public FinancialProducts(int products_id, String products_time, String products_name, String financial_institution_number, String products_online_payment, String products_payment_method, String products_state) {
        this.products_id = products_id;
        this.products_time = products_time;
        this.products_name = products_name;
        this.financial_institution_number = financial_institution_number;
