...
<head>
    ...
    <script>
        <c:choose>
            <c:when test="${roleName1=='风控授信人员' or roleName2=='风控授信人员'}">
        $(function(){
            $("#cusTable").bootstrapTable({
                url: "/getApplicantSelectState3.action", //获取数据的Servlet地址
                ...
                columns: [{
                ...
                },
                    {
                        ...
                        formatter: function (value, row, index) {
                            var e = '<button class="btn btn-primary btn" data-toggle="modal" data-target="#myModal">授信</button> ';
                            return e ;
                        }
                    }
                ]
