...
<head>
    ...
    <script>
<c:choose>
    <c:when test="${roleName1=='风控复审人员' or roleName2=='风控复审人员'}">
        $(function(){
            $("#cusTable").bootstrapTable({
                url: "/getApplicantSelectState2.action", //获取数据的Servlet地址
                ...
                columns: [{
                ...
                },
                    {
                        ...
                        formatter: function (value, row, index) {
                            var e = '<button class="btn btn-primary btn" data-toggle="modal" data-target="#myModal">复审</button> ';
                            return e ;
                        }
                    }
                ]
